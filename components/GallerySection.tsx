...
export default function GallerySection({ images }: GallerySectionProps) {
  ...
  return (
    <>
      ...
      <section
        className={`flex justify-center items-center w-full flex-col font-bold text-5xl text-center color-[#483A33] mb-[5rem] mt-24 no-select ${
          overlayActive ? "blur-content" : ""
        }`}
        aria-label="결혼식 사진첩"
      >
