    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row gap-4 text-3xl">
                <button
                    className={`px-4 py-2 rounded-lg ${newest ? "bg-[#F78DA7] text-white" : "bg-white text-[#F78DA7]"
                        }`}
            ...
            <div className="w-full flex flex-col items-center space-y-6">
                <div className="w-full flex flex-col items-center space-y-6">
                    {list.map((entry, index) => (
                        <div key={index} className="w-full border-b border-[#D4BDA2] py-4">
                            ...
                            <div className="mt-4 text-4xl" style={{ whiteSpace: 'pre-wrap' }}>{entry.message}</div> {/* 줄바꿈 허용 */}
                        </div>
                    ))}
                </div>
                ...
                <div className="w-full flex flex-row items-center justify-center space-x-4">
                    ...
                    {Array.from(
                        ...
                        <button
                            key={page}
                            className={`w-[5rem] h-[5rem] ${page === currentPage
